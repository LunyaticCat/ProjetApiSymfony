 ...
 */
final class Version20231116121002 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, id_category_id INT NOT NULL, name_item VARCHAR(255) NOT NULL, last_edited DATE DEFAULT NULL, INDEX IDX_1F1B251EA545015 (id_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
